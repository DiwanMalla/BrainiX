...
const coursesData: Course[] = [
  {
    ...
    instructorDetails: {
      name: "Diwan Malla",
      bio: "Diwan Malla is a seasoned web developer with extensive experience building modern web applications. Having worked with leading tech companies, he now dedicates his expertise to teaching aspiring developers the art of coding.",
      image:
  ...
  },
  {
    ...
    instructorDetails: {
      name: "Diwan Malla",
      bio: "Diwan Malla is a skilled data scientist with a deep passion for teaching. With years of experience in data analysis and machine learning, he brings practical insights to help students master data science concepts.",
      image:
  ...
  },
  {
    ...
    instructorDetails: {
      name: "Diwan Malla",
      bio: "Diwan Malla is an experienced UX/UI designer with a knack for creating user-friendly interfaces. With a background in design for tech companies, he now teaches others how to craft exceptional user experiences.",
      image:
  ...
  },
  {
    ...
    instructorDetails: {
      name: "Diwan Malla",
      bio: "Diwan Malla is a proficient data analyst and Python enthusiast with a strong track record in multiple industries. He excels at teaching how to turn complex data into actionable insights using Python.",
      image:
  ...
  },
  {
    ...
    instructorDetails: {
      name: "Diwan Malla",
      bio: "Diwan Malla is a frontend development expert with a focus on React and modern JavaScript frameworks. He enjoys teaching others how to build exceptional web applications using his extensive industry experience.",
      image:
  ...
  },
  {
    ...
    instructorDetails: {
      name: "Diwan Malla",
      bio: "Diwan Malla is a digital marketing expert with a proven track record of growing online presence for businesses. He brings his experience in SEO, content marketing, and paid advertising to teach effective strategies.",
      image:
