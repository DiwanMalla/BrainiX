...
export default function Home() {
  ...
  const handleLogToken = async () => {
    const token = await getToken({ template: "your-template-name" }); // Replace "your-template-name" with the actual template name if needed
  ...
  return (
    <div className="flex min-h-screen flex-col">
      <div>
        ...
        <button onClick={handleLogToken}>Log Token</button>
      </div>
      <Navbar />
