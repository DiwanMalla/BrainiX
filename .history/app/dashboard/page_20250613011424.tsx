...
export default function StudentDashboard() {
  ...
  return (
    <ThemeProvider attribute="class" defaultTheme="system" enableSystem>
      <div className="flex min-h-screen flex-col bg-gradient-to-br from-[#0f2027] via-[#2c5364] to-[#232526] text-foreground dark:bg-gradient-to-br dark:from-[#0f2027] dark:via-[#2c5364] dark:to-[#232526]">
        <Navbar />
