              ...
              {notifications.length > 0 ? (
                <ul className="space-y-2">
                  {notifications.map((notif) => (
                    <li
                      key={notif.id}
                      className={`flex flex-col gap-1 p-3 rounded bg-background/80 ${
            ...
            <div className="grid gap-6 md:grid-cols-2">
              {courses.length > 0 ? (
                courses.map((course) => (
                  <Card
                    key={course.id}
                    className="flex flex-col border border-border bg-card shadow-none hover:shadow-lg transition-shadow duration-200"
                  >
