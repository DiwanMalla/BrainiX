...
export default function AuthPage() {
  ...
  const handleSignUp = async (e: React.FormEvent) => {
    ...
    try {
      ...
      console.log("SignUp payload (pre-create):", payload);

      // Additional debug: Stringify to catch any transformation
      console.log("Payload as sent:", JSON.stringify(payload));

      const result = await signUp.create(payload);

      console.log("SignUp result:", result); // Log result for success case
      ...
      setError(
        errorMessage.includes("first_name is not a valid parameter")
          ? "Sign-up failed due to an internal error. Please try again or contact support."
