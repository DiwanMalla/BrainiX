  ...
  const markLessonComplete = async () => {
    ...
    try {
      ...
      const newProgress: Progress = {
        id:
          currentLesson.progress[0]?.id ||
          `progress-${currentLesson.id}-${Date.now()}`, // Generate a temporary ID if none exists
        completed: true,
        completedAt: new Date(),
        watchedSeconds: currentLesson.progress[0]?.watchedSeconds || 0,
        lastPosition: currentLesson.progress[0]?.lastPosition || 0,
        createdAt: currentLesson.progress[0]?.createdAt || new Date(),
        updatedAt: new Date(),
      };
      ...
      const updatedLesson: Lesson = {
        ...currentLesson,
        progress: currentLesson.progress.length ? [newProgress] : [newProgress],
