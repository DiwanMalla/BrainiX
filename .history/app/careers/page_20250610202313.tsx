    ...
    <main className="max-w-4xl mx-auto py-12 px-4 space-y-12">
      ...
      <section className="space-y-6">
        ...
        <div className="grid md:grid-cols-2 gap-6">
          {jobs.map((job) => (
            <div
              key={job.title}
              className="border rounded-lg p-6 bg-background shadow-sm flex flex-col justify-between"
            >
              <div>
      ...
      <section className="space-y-2">
        ...
        <p className="text-muted-foreground">
          ...
          . Please include the job title in your email subject. We look forward
          to hearing from you!
        </p>
      </section>
    </main>
