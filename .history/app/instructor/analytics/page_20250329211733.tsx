...
export default function InstructorAnalyticsPage() {
  ...
  useEffect(() => {
    ...
    console.log("Instructor Courses:", myCourses); // Debug course data
    ...
    console.log("Students:", instructorStudents); // Debug student data
  }, []);
  ...
  const timeFilteredEnrollments = filteredEnrollments.filter((e) => {
    const lastActiveDate = new Date(e.lastActive);
    if (timeRange === "7days")
      return (
        lastActiveDate >= new Date(now.getTime() - 7 * 24 * 60 * 60 * 1000)
      );
    if (timeRange === "30days")
      return (
        lastActiveDate >= new Date(now.getTime() - 30 * 24 * 60 * 60 * 1000)
      );
    return true; // "all"
  });
  ...
  console.log("Enrollment Trends Data:", enrollmentTrendsData); // Debug chart data
  ...
  console.log("Progress Distribution Data:", progressDistributionData); // Debug chart data
  ...
  console.log("Revenue by Course Data:", revenueByCourseData); // Debug chart data
