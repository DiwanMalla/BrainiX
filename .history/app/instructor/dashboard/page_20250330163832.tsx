...
export default function InstructorDashboard() {
  ...
  const instructorId = useUser().user.id; // Replace with Clerk auth logic (e.g., useUser().user.id)
  ...
  useEffect(() => {
    const fetchInstructorData = async () => {
      ...
      try {
        ...
        ); // Assume API supports this; adjust as needed
        ...
        const sortedEnrollments = allEnrollments
          ...
          .slice(0, 5); // Top 5 recent enrollments
