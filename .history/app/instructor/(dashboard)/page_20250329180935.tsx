  ...
  useEffect(() => {
    const fetchInstructorData = async () => {
      if (!isLoaded || !isSignedIn) {
        // Skip fetching data if user is not loaded or not signed in
        return;
      }

      try {
        const userId = user?.id; // Use optional chaining to safely access the user's ID
    ...
    fetchInstructorData();
  }, [user, isLoaded, isSignedIn]); // Adding dependencies
