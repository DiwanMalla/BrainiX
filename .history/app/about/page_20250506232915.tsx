          ...
          <div className="container px-4 md:px-6">
            <div className="bg-background/90 p-6 sm:p-8 rounded-lg border border-primary/10 shadow-lg">
              ...
              <p className="text-muted-foreground text-sm sm:text-base md:text-lg leading-relaxed max-w-4xl mx-auto">
                ...
                intelligent, and interactive for learners worldwide. Founded by a
                team of ambitious students, we leverage cutting-edge AI to create
                an e-learning platform that adapts to individual needs, fosters
                collaboration, and inspires lifelong learning. We believe
                knowledge should be a universal right, and we’re building the
          ...
          <div className="container px-4 md:px-6">
            <div className="bg-background/90 p-6 sm:p-8 rounded-lg border border-primary/10 shadow-lg">
              ...
              <div className="mt-8 text-center">
                ...
                >
                  <a href="/join-us">Join Our Mission</a>
                </Button>
              </div>
            </div>
          </div>
