        ...
        <section className="w-full py-12 md:py-16">
          <div className="container px-4 md:px-6">
            <motion.div
              ...
              animate={{ opacity: 1, y: 0 }}
              transition={{ duration: 0.5 }}
              className="bg-background/90 p-6 sm:p-8 rounded-lg border border-primary/10 shadow-lg"
            >
        ...
        <section className="w-full py-12 md:py-16 bg-gray-50">
          <div className="container px-4 md:px-6">
            <motion.h2
              ...
              animate={{ opacity: 1, y: 0 }}
              transition={{ duration: 0.5 }}
              className="text-2xl sm:text-3xl font-semibold text-foreground text-center mb-8"
            >
