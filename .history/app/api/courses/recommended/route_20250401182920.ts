  ...
  try {
    const courses = await prisma.course.findMany({
      ...
      include: {
        instructor: true,
        category: true,
        rating: true, // Add this if you're fetching ratings
        students: true, // Add this if you're fetching students
        bestseller: true, // Add this if you're fetching bestseller
        level: true,
      },
      take: 3,
