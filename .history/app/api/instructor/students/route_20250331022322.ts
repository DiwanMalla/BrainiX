      ...
      include: {
        user: {
          select: {
            ...
            name: true,
            email: true,
            country: true, // Assuming a country field exists in your User model
          },
        },
        course: {
          select: { title: true },
    ...
    enrollments.forEach((enrollment) => {
      ...
      if (!studentsMap.has(studentId)) {
        studentsMap.set(studentId, {
          ...
          country: enrollment.user.country || undefined,
          enrollments: [],
        });
      }
      studentsMap.get(studentId)!.enrollments.push({
        ...
        progress: enrollment.progress || 0, // Assuming progress is a field
        lastActive:
          enrollment.lastActive?.toISOString() ||
