...
interface Course {
  ...
  language: string;
  lastUpdated: string;
  instructor: { name: string; image: string; bio: string };
  ...
  <div className="mx-auto grid max-w-5xl gap-6 py-12 md:grid-cols-2 lg:grid-cols-3">
    {recommendedCourses.map((course) => (
      <CourseCard
        ...
        slug={course.slug}
        title={course.title}
        instructor={course.instructor?.name || "Unknown Instructor"} {/* Optional chaining here */}
        ...
        category={course.category?.name || "Uncategorized"} {/* Optional chaining here */}
        level={course.level}
