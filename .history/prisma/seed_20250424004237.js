...
**Note**: Update this section with AI-generated quizzes in the future.
          `,
...
**Instructions**: Answer the following questions. Replace with AI-generated questions later.
...
- Use Pathfinder to combine two shapes into a new form.
        ...
        },
        {
          ...
          type: "VIDEO",
          videoUrl: "https://www.youtube.com/watch?v=1yJ-_O8kN0U", // Gareth David Studio: Logo Design in Illustrator
      ...
      lessons: [
        {
          ...
          type: "VIDEO",
          videoUrl: "https://www.youtube.com/watch?v=Qj1FK8n7WgY", // Envato Tuts+: Color Theory for Designers
          duration: 480, // 8 minutes
          position: lessonPosition++,
          isPreview: false,
        },
    ...
    },
    {
      ...
      lessons: [
        ...
        },
        {
          ...
          type: "VIDEO",
          videoUrl: "https://www.youtube.com/watch?v=placeholder_infographic", // Placeholder: Search "Adobe Illustrator infographic tutorial"
          duration: 720, // 12 minutes
          position: lessonPosition++,
          isPreview: false,
          content: `
**Note**: Replace the placeholder URL with a real YouTube link. Search for "Adobe Illustrator infographic tutorial" on YouTube and select a high-quality video (e.g., from Envato Tuts+ or Adobe).
          `,
        },
        {
      ...
      lessons: [
        {
          ...
          type: "VIDEO",
          videoUrl: "https://www.youtube.com/watch?v=placeholder_portfolio", // Placeholder: Search "Graphic design portfolio tutorial"
          duration: 600, // 10 minutes
          position: lessonPosition++,
          isPreview: false,
          content: `
**Note**: Replace the placeholder URL with a real YouTube link. Search for "Graphic design portfolio tutorial" on YouTube and select a high-quality video (e.g., from Gareth David Studio or The Futur).
          `,
        },
        {
...
**Note**: Update this section with AI-generated quizzes in the future.
  ...
  console.log(`Seeded modules and lessons for course: ${course.title}`);
}
