...
async function main() {
  ...
  // Create or update a sample instructor
  ...
  await prisma.course.createMany({
    data: [
      // Web Development Courses (4)
      {
        ...
        description: 'Become a full-stack developer by learning HTML, CSS, JavaScript, React, Node.js, and MongoDB.',
        shortDescription: 'Master full-stack web development from scratch.',
        price: 199.99,
        discountPrice: 149.99,
        thumbnail: '/thumbnails/full-stack-bootcamp.jpg',
        ...
        learningObjectives: ['Build responsive websites', 'Develop backend APIs', 'Deploy full-stack applications'],
        targetAudience: ['Beginners', 'Aspiring developers', 'Career switchers'],
      ...
      },
      {
        ...
        description: 'Learn to build scalable, type-safe web applications using React and TypeScript.',
        ...
        learningObjectives: ['Build type-safe components', 'Integrate APIs', 'Optimize performance'],
      ...
      },
      {
        ...
        shortDescription: 'Create responsive layouts with CSS Grid and Flexbox.',
        price: 79.99,
        ...
        learningObjectives: ['Design responsive layouts', 'Use CSS Grid', 'Apply Flexbox techniques'],
      ...
      },
      {
        ...
        description: 'Build secure and scalable RESTful APIs using Node.js, Express, and PostgreSQL.',
        ...
        learningObjectives: ['Design RESTful APIs', 'Secure endpoints', 'Integrate databases'],
      ...
      // Data Science Courses (4)
      {
        ...
        thumbnail: '/thumbnails/data-science-python.jpg',
        level: CourseLevel.BEGINNER,
        status: CourseStatus.PUBLISHED,
        featured: true,
        published: true,
        ...
        learningObjectives: ['Analyze data with Pandas', 'Visualize with Seaborn', 'Build ML models'],
      ...
      },
      {
        ...
        description: 'Learn machine learning techniques and statistical modeling using R.',
        ...
        learningObjectives: ['Apply ML algorithms', 'Perform statistical analysis', 'Visualize data'],
      ...
      },
      {
        ...
        description: 'Learn to process and analyze large datasets using Apache Spark and PySpark.',
        ...
        learningObjectives: ['Process big data', 'Use PySpark', 'Optimize data pipelines'],
      ...
      },
      {
        ...
        description: 'Learn SQL to query and analyze large datasets for data science projects.',
        ...
        totalModules: 6,
        requirements: ['No prior experience needed'],
        learningObjectives: ['Write SQL queries', 'Analyze datasets', 'Join tables'],
      ...
      // Business Courses (3)
      {
        ...
        description: 'Learn SEO, content marketing, social media, and analytics to grow your business.',
        ...
        totalModules: 10,
        requirements: ['No prior experience needed'],
        learningObjectives: ['Create marketing campaigns', 'Optimize SEO', 'Analyze performance'],
      ...
      },
      {
        ...
        description: 'Learn Agile methodologies, Scrum, and Kanban for effective project management.',
        ...
        learningObjectives: ['Implement Scrum', 'Use Kanban boards', 'Lead Agile teams'],
      ...
      },
      {
        ...
        description: 'Learn to analyze business data and make data-driven decisions using Excel and Tableau.',
        ...
        totalModules: 7,
        requirements: ['No prior experience needed'],
        learningObjectives: ['Analyze business data', 'Create dashboards', 'Make data-driven decisions'],
      ...
      // Design Courses (4)
      {
        ...
        description: 'Learn user interface and experience design using Figma, Adobe XD, and user testing.',
        shortDescription: 'Become a UI/UX designer with hands-on projects.',
        price: 169.99,
        discountPrice: 119.99,
        thumbnail: '/thumbnails/ui-ux-bootcamp.jpg',
        level: CourseLevel.ALL_LEVELS,
        status: CourseStatus.PUBLISHED,
        featured: true,
        published: true,
        ...
        totalModules: 12,
        requirements: ['No prior experience needed'],
        learningObjectives: ['Design user interfaces', 'Conduct user research', 'Create prototypes'],
      ...
      },
      {
        ...
        totalModules: 9,
        requirements: ['No prior experience needed'],
        learningObjectives: ['Create logos', 'Design marketing materials', 'Edit images'],
      ...
      },
      {
        ...
        description: 'Create engaging animations and motion graphics using Adobe After Effects.',
        ...
        learningObjectives: ['Create animations', 'Design motion graphics', 'Export videos'],
      ...
      },
      {
        ...
        description: 'Learn 3D modeling, texturing, and animation using Blender for games and films.',
        ...
        totalModules: 8,
        requirements: ['No prior experience needed'],
        learningObjectives: ['Create 3D models', 'Apply textures', 'Animate objects'],
