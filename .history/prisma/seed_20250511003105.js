...
async function main() {
  ...
  // Ensure the course exists, create if not
  const course = await prisma.course.upsert({
    ...
    create: {
      ...
      description:
        "Master the essentials of business analytics to drive data-informed decisions in organizations. Learn data collection, statistical analysis, visualization, and tools like Excel, SQL, Tableau, and Power BI through practical exercises.",
    },
  });

  console.log(`Course ensured: ${course.title} (Slug: ${course.slug})`);
      ...
      lessons: [
        {
          ...
          type: "VIDEO",
          videoUrl: "https://www.youtube.com/watch?v=5jZ7H8C6k1o", // Placeholder: Intro to Business Analytics
      ...
      lessons: [
        {
          ...
          type: "VIDEO",
          videoUrl: "https://www.youtube.com/watch?v=0XgVhs5wL9Y", // Placeholder: Data Collection
          duration: 600, // 10 minutes
          position: lessonPosition++,
          isPreview: true,
        },
      ...
      lessons: [
        {
          ...
          type: "VIDEO",
          videoUrl: "https://www.youtube.com/watch?v=uhxtUt_-GyM", // Placeholder: Statistics Intro
          duration: 600, // 10 minutes
          position: lessonPosition++,
          isPreview: true,
        },
      ...
      lessons: [
        {
          ...
          type: "VIDEO",
          videoUrl: "https://www.youtube.com/watch?v=ubTJI_UphT4", // Placeholder: Data Visualization
          duration: 600, // 10 minutes
          position: lessonPosition++,
          isPreview: true,
        },
      ...
      lessons: [
        {
          ...
          type: "VIDEO",
          videoUrl: "https://www.youtube.com/watch?v=3F2W14rkE5k", // Placeholder: Excel Analytics
          duration: 600, // 10 minutes
          position: lessonPosition++,
          isPreview: true,
        },
      ...
      lessons: [
        {
          ...
          type: "VIDEO",
          videoUrl: "https://www.youtube.com/watch?v=7S_tz1z_5bA", // Placeholder: SQL Basics
          duration: 600, // 10 minutes
          position: lessonPosition++,
          isPreview: true,
        },
      ...
      lessons: [
        {
          ...
          type: "VIDEO",
          videoUrl: "https://www.youtube.com/watch?v=FaTZTgMg7OQ", // Placeholder: Predictive Analytics
          duration: 600, // 10 minutes
          position: lessonPosition++,
          isPreview: true,
        },
      ...
      lessons: [
        {
          ...
          type: "VIDEO",
          videoUrl: "https://www.youtube.com/watch?v=0myzW0ZBSc0", // Placeholder: Tableau Intro
          duration: 600, // 10 minutes
          position: lessonPosition++,
          isPreview: true,
        },
      ...
      lessons: [
        {
          ...
          type: "VIDEO",
          videoUrl: "https://www.youtube.com/watch?v=0myzW0ZBSc0", // Placeholder: Power BI Intro
          duration: 600, // 10 minutes
          position: lessonPosition++,
          isPreview: true,
        },
      ...
      lessons: [
        {
          ...
          type: "VIDEO",
          videoUrl: "https://www.youtube.com/watch?v=9Y1C3gqKPCs", // Placeholder: Analytics Decisions
          duration: 600, // 10 minutes
          position: lessonPosition++,
          isPreview: true,
        },
      ...
      lessons: [
        {
          ...
          type: "VIDEO",
          videoUrl: "https://www.youtube.com/watch?v=Z8Y3CwxW7nI", // Placeholder: Ethics in Analytics
          duration: 600, // 10 minutes
          position: lessonPosition++,
          isPreview: true,
        },
      ...
      lessons: [
        {
          ...
          type: "VIDEO",
          videoUrl: "https://www.youtube.com/watch?v=Z8Y3CwxW7nI", // Placeholder: Analytics Project
          duration: 600, // 10 minutes
          position: lessonPosition++,
          isPreview: true,
        },
