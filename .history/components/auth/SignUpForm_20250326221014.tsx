...
import { useClerk } from "@clerk/nextjs"; // Correct import for Clerk
...
export default function SignUpForm({
  ...
  const { loadCaptcha, captchaReady } = useClerk(); // using useClerk to manage CAPTCHA

  useEffect(() => {
    // Initialize CAPTCHA after the component mounts
    loadCaptcha();
  }, [loadCaptcha]);
      ...
      <div id="clerk-captcha" className="my-4">
        {captchaReady && (
          <div className="captcha-widget">
            Invisible CAPTCHA will appear here
          </div>
        )}
      </div>
