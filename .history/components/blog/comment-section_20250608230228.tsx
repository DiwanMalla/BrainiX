            ...
            .map((comment) => {
              ...
              return (
                <motion.div
                  ...
                  className="group"
                >
                  <Card className="border-0 border-l-4 border-primary/40 hover:border-primary transition-all duration-200 shadow-md hover:shadow-xl group-hover:-translate-y-1">
                    <CardContent className="pt-6 space-y-4">
                      {/* Comment Header */}
                      ...
                      {replies.length > 0 && (
                        ...
                        >
                          {replies.map((reply) => (
                            <div
                              key={reply.id}
                              className="flex items-start gap-3 pl-6 border-l-2 border-primary/20"
                            >
                ...
                >
                  ...
                  <p className="text-foreground mt-1">
                    {c.parentId && (
                      <span className="text-primary/80 font-medium">
                        @
                        {comments.find((p) => p.id === c.parentId)?.author
                          ?.name || "Anonymous"}
                        :{" "}
                      </span>
                    )}
