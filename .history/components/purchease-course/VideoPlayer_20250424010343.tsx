          ...
          <div className="prose max-w-none">
            {lesson.content ? (
              <ReactMarkdown
                ...
                className="text-gray-800 prose-headings:font-semibold prose-p:mb-4 prose-ul:list-disc prose-ol:list-decimal prose-li:ml-4"
              >
                {lesson.content}
              </ReactMarkdown>
            ) : (
          ...
          <div className="space-y-6">
            ...
            {lesson.assignment ? (
              <>
                <ReactMarkdown
                  remarkPlugins={[remarkGfm]}
                  className="prose max-w-none text-gray-800 prose-headings:font-semibold prose-p:mb-4 prose-ul:list-disc prose-ol:list-decimal prose-li:ml-4"
                >
