...
import { Course,Lesson } from "@/app/my-learning/[slug]/page";
    ...
    <div className="bg-card rounded-lg border shadow-sm p-4">
      <div className="flex flex-col md:flex-row md:items-center justify-between gap-4 mb-4">
        ...
        <div className="flex gap-2">
          ...
          >
            {lesson?.progress.completed ? "Already Completed" : "Mark as Complete"}
          </Button>
          <Button
            variant="outline"
            size="sm"
        ...
        <TabsContent value="content" className="p-4 border rounded-md mt-4">
          <div className="prose max-w-none">
            ...
            <p>
              ...
              implement the concepts covered and understand how they fit into the
              broader context of {course.title}.
            </p>
          </div>
        </TabsContent>
        ...
        <TabsContent value="ai-quiz" className="p-4 border rounded-md mt-4">
          <div className="space-y-4">
            ...
            <div className "space-y-6">
              ...
              <div className="p-4 border rounded-lg">
                <p className="font-medium mb-3">
                  2. Based on the content covered, which of the following best
                  describes the application of these principles?
                </p>
                <div className="space-y-2">
                  <div className="flex items-center gap-2">
                    <input type="radio" id="q2-a" name="q2" />
                    <label htmlFor="q2-a">
                      They lead to improvements in efficiency and effectiveness
                    </label>
                  </div>
                  <div className="flex items-center gap-2">
                    <input type="radio" id="q2-b" name="q2" />
                    <label htmlFor="q2-b">
                      They are primarily theoretical with limited practical use
                    </label>
                  </div>
                  <div className="flex items-center gap-2">
