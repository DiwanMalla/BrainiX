      ...
      <div className="container flex h-14 items-center">
        ...
        <div className="flex items-center gap-4">
          ...
          <Button
            size="sm"
            variant="outline"
            onClick={() => setShowNotes(!showNotes)} // Changed to pass boolean
          >
          ...
          <Button
            size="sm"
            variant="outline"
            onClick={() => setShowChat(!showChat)} // Changed to pass boolean
          >
          ...
          <Button
            size="sm"
            variant="outline"
            onClick={() => setShowSidebar(!showSidebar)} // Changed to pass boolean
          >
