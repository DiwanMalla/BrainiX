  ...
  const handleSave = async () => {
    ...
    try {
      ...
      if (response.ok) {
        ...
        router.push(`/instructor/courses/${params.slug}/edit-modules`);
      } else {
              ...
              <div className="flex items-center gap-2">
                <Button
                  ...
                  onClick={() => {
                    ...
                    const mockUrl = `https://example.com/videos/${lesson.id}.mp4`;
                    updateLesson(moduleId, lesson.id, { videoUrl: mockUrl });
                    toast({
                      title: "Video uploaded",
                      description:
                        "Mock video URL set (replace with actual upload)",
                    });
                  }}
                >
